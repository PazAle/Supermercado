...
public class CasosDePrueba {
	...
	public void queSePuedaInstanciarOtroComestible() {
		...
		assertEquals(2.0, ((Carne)producto).getKgs(), 0.1);
	}
	...
	public void queSePuedaInstanciarOtraIndumentaria() {
		...
		assertEquals("42", ((Zapatilla)producto).getTalle());
	...
	public void queSePuedanObtenerLosProductosComestibles() {
		...
		Set<Producto> productosComestibles = vital.obtenerProductosComestibles();
		List<Producto> productosComestiblesOrdenados = new ArrayList<>(productosComestibles);
		
		assertEquals((Integer)1, productosComestiblesOrdenados.get(0).getId());
		assertEquals((Integer)2, productosComestiblesOrdenados.get(1).getId());
		assertEquals((Integer)10, productosComestiblesOrdenados.get(2).getId());
	}
